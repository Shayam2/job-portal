  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>7021308994</p>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          RAIT NERUL,Mumbai<br>
           India</address>
          <p>
            <i class="icon-phone"></i> 7021308994 <br>
            <i class="icon-envelope-alt"></i> adityaanurag@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy;  Mini project 2022@project 
            </p>
          </div>
        </div>
        <div class="col-lg-6">
